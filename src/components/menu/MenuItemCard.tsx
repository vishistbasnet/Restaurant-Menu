                        ...
                        {item.pricing.options.map((option) => (
                            ...
                            >
                                ...
                                <button
                                    ...
                                    className="rounded-lg bg-yellow-400 px-3 py-1.5 text-xs font-bold text-gray-950 transition hover:bg-yellow-300 active:scale-95 disabled:cursor-not-allowed disabled:opacity-40"
                                >
                                    + Add
                                </button>
                            </div>
